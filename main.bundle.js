...
module.exports = "<div class=\"row product-overview\">\n  <div class=\"col-sm-3\" *ngFor=\"let product of trimmedProducts;\">\n    <div class=\"card theCardClass\">\n      <img class=\"card-img-top\" [src]=\"product.photoURL\" \n          (click)=\"triggerDetailSelection($event)\"  class=\"img-rounded\"  \n          width=\"100%\" height=\"100%\" [alt]=\"product.id\" [id]=\"product.code\" style=\"cursor: pointer;\"/>\n      <div class=\"card-block\">\n          <h4 class=\"card-title\">{{product.headerText}}  @{{product.cost}}</h4>\n          <p class=\"card-text\">{{product.bodyText.slice(0,30)}}</p> \n        </div>\n      </div>\n    </div>\n  </div>\n\n    "
...
var ProductOverviewComponent = (function () {
    ...
    ProductOverviewComponent.prototype.triggerDetailSelection = function (event) {
        ...
        var id = target.id;
        console.log(id);
        var theSelectedProduct = this.searchproductService.findByCode(id);
...
*/
    ...
    Product.prototype.getCode = function () { return this.code; };
    return Product;
}());
...
var SearchproductService = (function () {
    ...
    SearchproductService.prototype.searchColours = function (color, selectedColours) {
        if (typeof selectedColours === 'undefined' || selectedColours == null)
            return true;
        var fcColours = selectedColours;
        var prdColours = new Set(color);
        var retVal = false;
        console.log(retVal);
        return prdColours.has(selectedColours);
    };
    ...
    SearchproductService.prototype.findByCode = function (code) {
        console.log("inside findByValue :: " + code);
        var item = this.originalProductsList.find(function (pro) { return pro.getCode() == code; });
        console.log("inside findByValue :: " + item);
        return item;
    };
